package benchmarks.detinfer.tsp;
/*
...
public class Tsp {
	...
	if (!nop) {
            ...
            openDeterministicBlock(new String[] { "args", "fname", "nop" },
                                   new Object[] {  args,   fname,   nop  });
	    ...
	    long end = new Date().getTime();
            ...
            closeDeterministicBlock(new String[] { "args", "fname", "nop", "start", "t", "end" },
                                    new Object[] {  args,   fname,   nop,   start,   t,   end  });
