//******************************************************************************
//
// File:    Unsigned16BitIntegerMatrixReductionBuf.java
// Package: benchmarks.detinfer.pj.edu.ritmp.buf
// Unit:    Class benchmarks.detinfer.pj.edu.ritmp.buf.Unsigned16BitIntegerMatrixReductionBuf
//
 ...
 * class {@linkplain Unsigned16BitIntegerMatrixBuf}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class Unsigned16BitIntegerMatrixReductionBuf
...
// Exported constructors.
	 ...
	 */
	public Unsigned16BitIntegerMatrixReductionBuf
		(int[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 IntegerOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("Unsigned16BitIntegerMatrixReductionBuf(): op is null");
			}
		myOp = op;
		}
