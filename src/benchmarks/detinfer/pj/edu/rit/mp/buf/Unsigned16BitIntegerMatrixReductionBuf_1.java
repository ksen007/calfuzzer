//******************************************************************************
//
// File:    Unsigned16BitIntegerMatrixReductionBuf_1.java
// Package: benchmarks.detinfer.pj.edu.ritmp.buf
// Unit:    Class benchmarks.detinfer.pj.edu.ritmp.buf.Unsigned16BitIntegerMatrixReductionBuf_1
//
...
import benchmarks.detinfer.pj.edu.ritmp.Unsigned16BitIntegerBuf;
...
/**
 * Class Unsigned16BitIntegerMatrixReductionBuf_1 provides a reduction buffer
 * for class {@linkplain Unsigned16BitIntegerMatrixBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class Unsigned16BitIntegerMatrixReductionBuf_1
	extends Unsigned16BitIntegerMatrixBuf_1
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new unsigned 16-bit integer matrix reduction buffer. It is
	 ...
	 */
	public Unsigned16BitIntegerMatrixReductionBuf_1
		(int[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 IntegerOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("Unsigned16BitIntegerMatrixReductionBuf_1(): op is null");
			}
		myOp = op;
		}
	...
	protected int receiveItems
		...
		while (r < myRowCount && ncols > 0)
			...
			while (c < ncols)
				{
				myMatrix_row[col] =
					myOp.op (myMatrix_row[col], shortbuffer.get() & 0xFFFF);
				++ c;
				++ col;
				}
			n += ncols;
