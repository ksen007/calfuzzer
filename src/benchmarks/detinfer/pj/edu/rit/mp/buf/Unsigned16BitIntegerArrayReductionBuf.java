//******************************************************************************
//
// File:    Unsigned16BitIntegerArrayReductionBuf.java
// Package: benchmarks.detinfer.pj.edu.ritmp.buf
// Unit:    Class benchmarks.detinfer.pj.edu.ritmp.buf.Unsigned16BitIntegerArrayReductionBuf
//
...
/**
 * Class Unsigned16BitIntegerArrayReductionBuf provides a reduction buffer for
 * class {@linkplain Unsigned16BitIntegerArrayBuf}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class Unsigned16BitIntegerArrayReductionBuf
...
// Exported constructors.
	 ...
	 */
	public Unsigned16BitIntegerArrayReductionBuf
		(int[] theArray,
		 Range theRange,
		 IntegerOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("Unsigned16BitIntegerArrayReductionBuf(): op is null");
			}
		myOp = op;
		}
