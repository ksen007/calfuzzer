//******************************************************************************
//
// File:    Unsigned16BitIntegerArrayReductionBuf_1.java
// Package: benchmarks.detinfer.pj.edu.ritmp.buf
// Unit:    Class benchmarks.detinfer.pj.edu.ritmp.buf.Unsigned16BitIntegerArrayReductionBuf_1
//
...
/**
 * Class Unsigned16BitIntegerArrayReductionBuf_1 provides a reduction buffer for
 * class {@linkplain Unsigned16BitIntegerArrayBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class Unsigned16BitIntegerArrayReductionBuf_1
	extends Unsigned16BitIntegerArrayBuf_1
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new unsigned 16-bit integer array reduction buffer.
	 *
	 ...
	 */
	public Unsigned16BitIntegerArrayReductionBuf_1
		(int[] theArray,
		 Range theRange,
		 IntegerOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("Unsigned16BitIntegerArrayReductionBuf_1(): op is null");
			}
		myOp = op;
		}
...
// Hidden operations.
	...
	protected int receiveItems
		...
		while (index < max && buffer.remaining() >= 2)
			{
			myArray[off] = myOp.op (myArray[off], buffer.getShort() & 0xFFFF);
			++ index;
			++ off;
			}
		return index - i;
