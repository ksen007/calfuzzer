//******************************************************************************
//
// File:    EmptyUnsigned16BitIntegerBuf.java
// Package: benchmarks.detinfer.pj.edu.ritmp.buf
// Unit:    Class benchmarks.detinfer.pj.edu.ritmp.buf.EmptyUnsigned16BitIntegerBuf
//
 ...
 * message is sent from an EmptyUnsigned16BitIntegerBuf, the message item type
 * is unsigned 16-bit <TT>int</TT> and the message length is 0. When a message
 * is received into an EmptyUnsigned16BitIntegerBuf, the message item type must
 * be unsigned 16-bit <TT>int</TT>, but all items in the message are discarded.
 *
 * @author  Alan Kaminsky
 * @version 19-Nov-2007
 */
public class EmptyUnsigned16BitIntegerBuf
