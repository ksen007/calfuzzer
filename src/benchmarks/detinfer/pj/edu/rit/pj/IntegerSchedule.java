...
// Unit:    Class benchmarks.detinfer.pj.edu.ritpj.IntegerSchedule
//
...
// Hidden operations.
	...
	private static String getSubclassName
		...
		if (name.equals ("fixed"))
			{
			return "benchmarks.detinfer.pj.edu.ritpj.FixedIntegerSchedule";
			}
		else if (name.equals ("dynamic"))
			{
			return "benchmarks.detinfer.pj.edu.ritpj.DynamicIntegerSchedule";
			}
		else if (name.equals ("guided"))
			{
			return "benchmarks.detinfer.pj.edu.ritpj.GuidedIntegerSchedule";
			}
		else
			{
			return name;
...
//		if (args.length != 4)
//			{
//			System.err.println ("Usage: java [-Dpj.schedule=<SCHEDULE>] benchmarks.detinfer.pj.edu.ritpj.IntegerSchedule <K> <lb> <ub> <stride>");
//			System.exit (1);
//			}
