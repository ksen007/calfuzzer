...
// Unit:    Class benchmarks.detinfer.pj.edu.ritpj.PJProperties
//
 ...
 * computer (see package {@linkplain benchmarks.detinfer.pj.edu.ritpj.cluster benchmarks.determinism.pj.edu.ritpj.cluster} for
...
// Exported operations.
	 ...
	 * benchmarks.detinfer.pj.edu.ritpj.cluster benchmarks.determinism.pj.edu.ritpj.cluster} and class {@linkplain
	 * benchmarks.detinfer.pj.edu.ritpj.cluster.JobScheduler}.
	 * <P>
	...
	public static int getPjPort()
		...
		try
			...
			int port =
				pj_port == null ?
					// benchmarks.detinfer.pj.edu.ritpj.cluster.Constants.PJ_PORT :
					20617 :
	 ...
	 * {@linkplain benchmarks.detinfer.pj.edu.ritpj.cluster benchmarks.determinism.pj.edu.ritpj.cluster}.
	 * <P>
	 ...
	 * benchmarks.detinfer.pj.edu.ritutil.Random} will construct. Specifying the <TT>"pj.prng"</TT>
	 * property will substitute a different PRNG algorithm into a program
	 * without needing to recompile. See class {@linkplain benchmarks.detinfer.pj.edu.ritutil.Random}
	 * for further information.
	 * <P>
	 * If the <TT>"pj.prng"</TT> Java system property is not specified, a PRNG
	 * class name of <TT>"benchmarks.detinfer.pj.edu.ritutil.DefaultRandom"</TT> is returned. See
	 * class {@linkplain benchmarks.detinfer.pj.edu.ritutil.DefaultRandom} for further information.
	 *
	 * @return  Default PRNG class name.
	 */
	public static String getPjPrng()
		{
		return System.getProperty ("pj.prng", "benchmarks.detinfer.pj.edu.ritutil.DefaultRandom");
		}
