...
// Unit:    Class benchmarks.detinfer.pj.edu.ritcompbio.seq.test.ExtractProtein
//
 ...
 * benchmarks.detinfer.pj.edu.ritcompbio.seq.ProteinSequence}. The program extracts the protein
 * sequence at a given index from the protein sequence database and prints it on
 * the standard output in FASTA format.
 * <P>
 * Usage: java benchmarks.detinfer.pj.edu.ritcompbio.seq.test.ExtractProtein <I>databasefile</I>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java benchmarks.detinfer.pj.edu.ritcompbio.seq.test.ExtractProtein <databasefile> <indexfile> <index>");
