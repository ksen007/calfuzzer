...
// Unit:    Class benchmarks.detinfer.pj.edu.ritcompbio.seq.test.TestSmp
//
...
import benchmarks.detinfer.pj.edu.ritcompbio.seq.ProteinLocalAlignmentSmp;
 ...
 * benchmarks.detinfer.pj.edu.ritcompbio.seq.ProteinLocalAlignmentSmp}. The program reads in a query
 * sequence and a subject sequence, aligns them in a parallel thread team, and
 * prints the alignment.
 * <P>
 * Usage: java -Dpj.nt=<I>K</I> benchmarks.detinfer.pj.edu.ritcompbio.seq.test.TestSmp
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.nt=<K> benchmarks.detinfer.pj.edu.ritcompbio.seq.test.TestSmp <queryfile> <subjectfile>");
