...
// Unit:    Class benchmarks.detinfer.pj.edu.rithyb.fractal.MandelbrotSetHyb2
//
 ...
 * benchmarks.detinfer.pj.edu.ritpj.IntegerSchedule IntegerSchedule}.
 * <P>
 * Usage: java -Dpj.np=<I>Kp</I> -Dpj.nt=<I>Kt</I> [
 * -Dpj.schedule=<I>procschedule</I> ] benchmarks.detinfer.pj.edu.rithyb.fractal.MandelbrotSetHyb2
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<Kp> -Dpj.nt=<Kt> [-Dpj.schedule=<procschedule>] benchmarks.detinfer.pj.edu.rithyb.fractal.MandelbrotSetHyb2 <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <gamma> <filename> [<thrschedule>]");
