...
// Unit:    Class benchmarks.detinfer.pj.edu.ritsmp.keysearch.FindKeySmp3
//
 ...
 * interference.
 * <P>
 * Usage: java [ -Dpj.nt=<I>K</I> ] benchmarks.detinfer.pj.edu.ritsmp.keysearch.FindKeySmp3
...
// Main program.
	...
	public static void main
		...
		long t2 = System.currentTimeMillis();
                ...
                closeDeterministicBlock(new String[] { "args", "t1", "t2" },
                                        new Object[] {  args,   t1,   t2 });
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java [-Dpj.nt=<K>] benchmarks.detinfer.pj.edu.ritsmp.keysearch.FindKeySmp3 <plaintext> <ciphertext> <partialkey> <n>");
