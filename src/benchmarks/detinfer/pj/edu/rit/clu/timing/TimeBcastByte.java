...
// Unit:    Class benchmarks.detinfer.pj.edu.ritclu.timing.TimeBcastByte
//
 ...
 * message size <I>n</I>.
 * <P>
 * Usage: java -Dpj.np=<I>K</I> benchmarks.detinfer.pj.edu.ritclu.timing.TimeBcastByte <I>reps</I>
 * <I>n1</I> [ <I>n2</I> . . . ]
...
// Main program.
	...
	public static void main
		...
		if (rank == 0)
			...
			System.out.println
				("java -Dpj.np=" + size +
				 " benchmarks.detinfer.pj.edu.ritclu.timing.TimeBcastByte " + reps);
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<K> benchmarks.detinfer.pj.edu.ritclu.timing.TimeBcastByte <reps> <n1> [<n2> ...]");
