...
// Unit:    Class benchmarks.detinfer.pj.edu.ritclu.timing.TimeSendByte
//
 ...
 * <I>n</I>.
 * <P>
 * Usage: java -Dpj.np=2 benchmarks.detinfer.pj.edu.ritclu.timing.TimeSendByte <I>reps</I> <I>n1</I>
 * [ <I>n2</I> . . . ]
...
// Main program.
	...
	public static void main
		...
		if (rank == 0)
			{
			System.out.println
				("java -Dpj.np=2 benchmarks.detinfer.pj.edu.ritclu.timing.TimeSendByte " + reps);
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=2 benchmarks.detinfer.pj.edu.ritclu.timing.TimeSendByte <reps> <n1> [<n2> ...]");
