...
package benchmarks.detinfer.jgf.series;
...
void Do()
{
    ...
    openDeterministicBlock(new String[] { "this", "thobjects", "th" },
                           new Object[] {  this,   thobjects,   th  });

    JGFInstrumentor.startTimer("Section2:Series:Kernel");

    //Start Threads

    for(int i=1; i < JGFSeriesBench.nthreads; i++) {
    ...
    closeDeterministicBlock(new String[] { "this", "thobjects", "th" },
                            new Object[] {  this,   thobjects,   th  });
}
void freeTestData()
{
