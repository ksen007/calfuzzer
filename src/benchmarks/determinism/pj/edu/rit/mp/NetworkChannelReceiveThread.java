...
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.NetworkChannelReceiveThread
//
			...
			try
				...
				if (magic != Constants.MAGIC_NUMBER)
					...
					myChannelGroup.myLogger.log
						("benchmarks.determinism.pj.edu.ritmp.NetworkChannelReceiveThread: Invalid magic number received");
