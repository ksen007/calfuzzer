...
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.EmptyShortBuf
//
 ...
 * EmptyShortBuf, the message item type is <TT>short</TT> and the message
 * length is 0. When a message is received into an EmptyShortBuf, the message
 * item type must be <TT>short</TT>, but all items in the message are
 * discarded.
 *
