//******************************************************************************
//
// File:    Signed8BitIntegerMatrixReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Signed8BitIntegerMatrixReductionBuf
//
...
/**
 * Class Signed8BitIntegerMatrixReductionBuf provides a reduction buffer for
 * class {@linkplain Signed8BitIntegerMatrixBuf}.
 *
...
// Exported constructors.
	 ...
	 */
	public Signed8BitIntegerMatrixReductionBuf
		(int[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 IntegerOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("Signed8BitIntegerMatrixReductionBuf(): op is null");
			}
		myOp = op;
		}
