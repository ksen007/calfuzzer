//******************************************************************************
//
// File:    SharedLongArrayBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedLongArrayBuf
//
...
/**
 * Class SharedLongArrayBuf provides a buffer for a multiple thread safe
 ...
 * class SharedLongArrayBuf may be constructed directly, normally you will
 * use a factory method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.LongBuf
 * LongBuf}. See that class for further information.
 *
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new SharedLongArrayReductionBuf
