//******************************************************************************
//
// File:    FloatMatrixReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.FloatMatrixReductionBuf_1
//
...
/**
 * Class FloatMatrixReductionBuf_1 provides a reduction buffer for class
 * {@linkplain FloatMatrixBuf_1}.
 *
...
// Exported constructors.
	 ...
	 */
	public FloatMatrixReductionBuf_1
		(float[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 FloatOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("FloatMatrixReductionBuf_1(): op is null");
			}
		myOp = op;
		}
