//******************************************************************************
//
// File:    CharacterMatrixReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.CharacterMatrixReductionBuf
//
...
/**
 * Class CharacterMatrixReductionBuf provides a reduction buffer for class
 * {@linkplain CharacterMatrixBuf}.
 *
...
// Exported constructors.
	 ...
	 */
	public CharacterMatrixReductionBuf
		(char[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 CharacterOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("CharacterMatrixReductionBuf(): op is null");
			}
		myOp = op;
		}
