//******************************************************************************
//
// File:    LongArrayReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.LongArrayReductionBuf_1
//
...
/**
 * Class LongArrayReductionBuf_1 provides a reduction buffer for class
 * {@linkplain LongArrayBuf_1}.
 *
...
// Exported constructors.
	 ...
	 */
	public LongArrayReductionBuf_1
		(long[] theArray,
		 Range theRange,
		 LongOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("LongArrayReductionBuf_1(): op is null");
			}
		myOp = op;
		}
