//******************************************************************************
//
// File:    IntegerMatrixReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.IntegerMatrixReductionBuf
//
...
/**
 * Class IntegerMatrixReductionBuf provides a reduction buffer for class
 * {@linkplain IntegerMatrixBuf}.
 *
 * @author  Alan Kaminsky
 * @version 25-Oct-2007
 */
class IntegerMatrixReductionBuf
...
// Exported constructors.
	 ...
	 */
	public IntegerMatrixReductionBuf
		(int[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 IntegerOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("IntegerMatrixReductionBuf(): op is null");
			}
		myOp = op;
		}
