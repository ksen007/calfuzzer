//******************************************************************************
//
// File:    FloatArrayReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.FloatArrayReductionBuf_1
//
...
/**
 * Class FloatArrayReductionBuf_1 provides a reduction buffer for class
 * {@linkplain FloatArrayBuf_1}.
 *
...
// Exported constructors.
	...
	/**
	 * Construct a new float array reduction buffer.
	 *
	 ...
	 */
	public FloatArrayReductionBuf_1
		(float[] theArray,
		 Range theRange,
		 FloatOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("FloatArrayReductionBuf_1(): op is null");
			}
		myOp = op;
		}
...
// Hidden operations.
	...
	protected int receiveItems
		...
		while (index < max && buffer.remaining() >= 4)
			{
			myArray[off] = myOp.op (myArray[off], buffer.getFloat());
			++ index;
			++ off;
			}
		return index - i;
