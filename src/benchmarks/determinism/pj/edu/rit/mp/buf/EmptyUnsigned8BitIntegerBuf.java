...
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.EmptyUnsigned8BitIntegerBuf
//
 ...
 * message is sent from an EmptyUnsigned8BitIntegerBuf, the message item type
 * is unsigned 8-bit <TT>int</TT> and the message length is 0. When a message
 * is received into an EmptyUnsigned8BitIntegerBuf, the message item type must
 * be unsigned 8-bit <TT>int</TT>, but all items in the message are discarded.
 *
