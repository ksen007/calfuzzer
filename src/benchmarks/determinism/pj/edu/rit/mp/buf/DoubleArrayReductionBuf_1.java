//******************************************************************************
//
// File:    DoubleArrayReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.DoubleArrayReductionBuf_1
//
...
/**
 * Class DoubleArrayReductionBuf_1 provides a reduction buffer for class
 * {@linkplain DoubleArrayBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 25-Oct-2007
 */
class DoubleArrayReductionBuf_1
	extends DoubleArrayBuf_1
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new double array reduction buffer.
	 *
	 ...
	 */
	public DoubleArrayReductionBuf_1
		(double[] theArray,
		 Range theRange,
		 DoubleOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("DoubleArrayReductionBuf_1(): op is null");
			}
		myOp = op;
		}
...
// Exported operations.
	...
	public void copy
		...
		else if (theSrc instanceof DoubleArrayBuf)
			{
...
// Hidden operations.
	...
	protected int receiveItems
		...
		while (index < max && buffer.remaining() >= 8)
			{
			myArray[off] = myOp.op (myArray[off], buffer.getDouble());
			++ index;
			++ off;
			}
		return index - i;
