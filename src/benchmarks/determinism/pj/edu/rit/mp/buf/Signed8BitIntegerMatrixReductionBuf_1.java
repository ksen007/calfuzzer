//******************************************************************************
//
// File:    Signed8BitIntegerMatrixReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Signed8BitIntegerMatrixReductionBuf_1
//
...
import benchmarks.determinism.pj.edu.ritmp.Signed8BitIntegerBuf;
...
/**
 * Class Signed8BitIntegerMatrixReductionBuf_1 provides a reduction buffer for
 * class {@linkplain Signed8BitIntegerMatrixBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class Signed8BitIntegerMatrixReductionBuf_1
	extends Signed8BitIntegerMatrixBuf_1
	{
...
// Exported constructors.
	 ...
	 */
	public Signed8BitIntegerMatrixReductionBuf_1
		(int[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 IntegerOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("Signed8BitIntegerMatrixReductionBuf_1(): op is null");
			}
		myOp = op;
		}
...
// Exported operations.
	...
	public void copy
		...
		if (theSrc == this)
		...
		else if (theSrc instanceof Signed8BitIntegerMatrixBuf)
			{
			Signed8BitIntegerMatrixBuf src =
				(Signed8BitIntegerMatrixBuf) theSrc;
			ReduceArrays.reduce
			...
			Signed8BitIntegerBuf.defaultCopy
				((Signed8BitIntegerBuf) theSrc, this);
			}
		}
...
// Hidden operations.
	...
	protected int receiveItems
		...
		while (r < myRowCount && ncols > 0)
			...
			while (c < ncols)
				{
				myMatrix_row[col] = myOp.op (myMatrix_row[col], buffer.get());
				++ c;
				++ col;
				}
			n += ncols;
