//******************************************************************************
//
// File:    Signed16BitIntegerItemBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Signed16BitIntegerItemBuf
//
 ...
 * integer item sent or received using the Message Protocol (MP). While an
 * instance of class Signed16BitIntegerItemBuf may be constructed directly,
 ...
 * @version 26-Oct-2007
 */
public class Signed16BitIntegerItemBuf
...
// Exported constructors.
	 ...
	 */
	public Signed16BitIntegerItemBuf()
		{
		super (1);
		}

	/**
	 * Construct a new signed 16-bit integer item buffer with the given initial
	 * value.
	 *
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new Signed16BitIntegerItemReductionBuf (this, (IntegerOp) op);
		}
