//******************************************************************************
//
// File:    SharedFloatBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedFloatBuf
//
 ...
 * SharedFloatBuf may be constructed directly, normally you will use a factory
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new SharedFloatReductionBuf (myItem, (FloatOp) op);
		}
