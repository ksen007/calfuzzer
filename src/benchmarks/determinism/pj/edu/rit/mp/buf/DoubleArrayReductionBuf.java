//******************************************************************************
//
// File:    DoubleArrayReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.DoubleArrayReductionBuf
//
...
/**
 * Class DoubleArrayReductionBuf provides a reduction buffer for class
 * {@linkplain DoubleArrayBuf}.
 *
...
// Exported constructors.
	 ...
	 */
	public DoubleArrayReductionBuf
		(double[] theArray,
		 Range theRange,
		 DoubleOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("DoubleArrayReductionBuf(): op is null");
			}
		myOp = op;
		}
