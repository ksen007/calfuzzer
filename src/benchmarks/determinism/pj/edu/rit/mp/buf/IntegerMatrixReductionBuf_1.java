...
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.IntegerMatrixReductionBuf_1
//
...
// Exported constructors.
	 ...
	 */
	public IntegerMatrixReductionBuf_1
		(int[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 IntegerOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("IntegerMatrixReductionBuf_1(): op is null");
			}
		myOp = op;
		}
