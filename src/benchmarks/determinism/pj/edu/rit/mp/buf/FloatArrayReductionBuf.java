//******************************************************************************
//
// File:    FloatArrayReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.FloatArrayReductionBuf
//
 ...
 * {@linkplain FloatArrayBuf}.
 *
 * @author  Alan Kaminsky
 * @version 25-Oct-2007
 */
class FloatArrayReductionBuf
	...
	public FloatArrayReductionBuf
		...
		if (op == null)
			...
			throw new NullPointerException
				("FloatArrayReductionBuf(): op is null");
			}
		myOp = op;
		}
