//******************************************************************************
//
// File:    Unsigned8BitIntegerMatrixReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Unsigned8BitIntegerMatrixReductionBuf
//
...
/**
 * Class Unsigned8BitIntegerMatrixReductionBuf provides a reduction buffer for
 * class {@linkplain Unsigned8BitIntegerMatrixBuf}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class Unsigned8BitIntegerMatrixReductionBuf
...
// Exported constructors.
	 ...
	 */
	public Unsigned8BitIntegerMatrixReductionBuf
		(int[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 IntegerOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("Unsigned8BitIntegerMatrixReductionBuf(): op is null");
			}
		myOp = op;
		}
