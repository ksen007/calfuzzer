//******************************************************************************
//
// File:    CharacterArrayReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.CharacterArrayReductionBuf_1
//
...
/**
 * Class CharacterArrayReductionBuf_1 provides a reduction buffer for class
 * {@linkplain CharacterArrayBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 25-Oct-2007
 */
class CharacterArrayReductionBuf_1
	extends CharacterArrayBuf_1
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new character array reduction buffer.
	 *
	 ...
	 */
	public CharacterArrayReductionBuf_1
		(char[] theArray,
		 Range theRange,
		 CharacterOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("CharacterArrayReductionBuf_1(): op is null");
			}
		myOp = op;
		}
...
// Exported operations.
	...
	public void copy
		...
		else if (theSrc instanceof CharacterArrayBuf)
			{
...
// Hidden operations.
	...
	protected int receiveItems
		...
		while (index < max && buffer.remaining() >= 2)
			{
			myArray[off] = myOp.op (myArray[off], buffer.getChar());
			++ index;
			++ off;
			}
		return index - i;
