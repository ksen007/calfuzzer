...
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedSigned16BitIntegerBuf
//
...
// Exported constructors.
	 ...
	 */
	public SharedSigned16BitIntegerBuf
		(SharedInteger item)
		{
		super (1);
		myItem = item;
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new SharedSigned16BitIntegerReductionBuf
			(myItem, (IntegerOp) op);
		}
