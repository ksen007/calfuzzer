//******************************************************************************
//
// File:    SharedShortArrayBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedShortArrayBuf
//
...
/**
 * Class SharedShortArrayBuf provides a buffer for a multiple thread safe
 ...
 * class SharedShortArrayBuf may be constructed directly, normally you will
 * use a factory method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.ShortBuf
 * ShortBuf}. See that class for further information.
 *
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new SharedShortArrayReductionBuf
