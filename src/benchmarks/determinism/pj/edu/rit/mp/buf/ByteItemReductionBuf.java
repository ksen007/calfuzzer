//******************************************************************************
//
// File:    ByteItemReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.ByteItemReductionBuf
//
...
/**
 * Class ByteItemReductionBuf provides a reduction buffer for class
 * {@linkplain ByteItemBuf}.
 *
	...
	public ByteItemReductionBuf
		...
		if (op == null)
			...
			throw new NullPointerException
				("ByteItemReductionBuf(): op is null");
			}
		myBuf = buf;
		myOp = op;
		}
