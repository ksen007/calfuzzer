//******************************************************************************
//
// File:    FloatItemReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.FloatItemReductionBuf
//
...
/**
 * Class FloatItemReductionBuf provides a reduction buffer for class
 * {@linkplain FloatItemBuf}.
 *
	...
	public FloatItemReductionBuf
		...
		if (op == null)
			...
			throw new NullPointerException
				("FloatItemReductionBuf(): op is null");
			}
		myBuf = buf;
		myOp = op;
		}
...
// Hidden operations.
	...
	protected int receiveItems
		...
		if (num >= 1 && buffer.remaining() >= 4)
			{
			myBuf.item = myOp.op (myBuf.item, buffer.getFloat());
			return 1;
			}
		else
			{
