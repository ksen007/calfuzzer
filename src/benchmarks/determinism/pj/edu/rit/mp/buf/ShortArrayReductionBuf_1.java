//******************************************************************************
//
// File:    ShortArrayReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.ShortArrayReductionBuf_1
//
...
/**
 * Class ShortArrayReductionBuf_1 provides a reduction buffer for class
 * {@linkplain ShortArrayBuf_1}.
 *
...
// Exported constructors.
	 ...
	 */
	public ShortArrayReductionBuf_1
		(short[] theArray,
		 Range theRange,
		 ShortOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("ShortArrayReductionBuf_1(): op is null");
			}
		myOp = op;
		}
