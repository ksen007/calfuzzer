...
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedLongBuf
//
...
/**
 * Class SharedLongBuf provides a buffer for a shared long item sent or
 * received using the Message Protocol (MP). While an instance of class
 * SharedLongBuf may be constructed directly, normally you will use a factory
