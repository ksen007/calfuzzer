//******************************************************************************
//
// File:    Signed8BitIntegerArrayBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Signed8BitIntegerArrayBuf
//
 ...
 * Signed8BitIntegerArrayBuf may be constructed directly, normally you will use
 * a factory method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.Signed8BitIntegerBuf
 * Signed8BitIntegerBuf}. See that class for further information.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
public class Signed8BitIntegerArrayBuf
...
// Exported constructors.
	 ...
	 */
	public Signed8BitIntegerArrayBuf
		(int[] theArray,
		 Range theRange)
		{
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new Signed8BitIntegerArrayReductionBuf
