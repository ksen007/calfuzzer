//******************************************************************************
//
// File:    CharacterMatrixReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.CharacterMatrixReductionBuf_1
//
...
/**
 * Class CharacterMatrixReductionBuf_1 provides a reduction buffer for class
 * {@linkplain CharacterMatrixBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 25-Oct-2007
 */
class CharacterMatrixReductionBuf_1
	extends CharacterMatrixBuf_1
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new character matrix reduction buffer. It is assumed that the
	 ...
	 */
	public CharacterMatrixReductionBuf_1
		(char[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 CharacterOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("CharacterMatrixReductionBuf_1(): op is null");
			}
		myOp = op;
		}
	...
	protected int receiveItems
		...
		while (r < myRowCount && ncols > 0)
			...
			while (c < ncols)
				{
				myMatrix_row[col] =
					myOp.op (myMatrix_row[col], charbuffer.get());
				++ c;
				++ col;
				}
			n += ncols;
