//******************************************************************************
//
// File:    LongItemBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.LongItemBuf
//
...
/**
 * Class LongItemBuf provides a buffer for a single long item sent or
 * received using the Message Protocol (MP). While an instance of class
 * LongItemBuf may be constructed directly, normally you will use a factory
 * method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.LongBuf LongBuf}. See that
 * class for further information.
 *
 * @author  Alan Kaminsky
 * @version 25-Oct-2007
 */
public class LongItemBuf
	extends LongBuf
	{
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new LongItemReductionBuf (this, (LongOp) op);
		}
