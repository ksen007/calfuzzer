//******************************************************************************
//
// File:    Signed8BitIntegerMatrixBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Signed8BitIntegerMatrixBuf
//
 ...
 * matrix row and column strides may be 1 or greater than 1. While an instance
 * of class Signed8BitIntegerMatrixBuf may be constructed directly, normally you
 * will use a factory method in class {@linkplain
 ...
 * @version 03-Mar-2008
 */
public class Signed8BitIntegerMatrixBuf
...
// Exported constructors.
	 ...
	 */
	public Signed8BitIntegerMatrixBuf
		(int[][] theMatrix,
		 Range theRowRange,
		 Range theColRange)
		{
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new Signed8BitIntegerMatrixReductionBuf
