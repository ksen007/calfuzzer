//******************************************************************************
//
// File:    Signed8BitIntegerArrayReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Signed8BitIntegerArrayReductionBuf_1
//
...
/**
 * Class Signed8BitIntegerArrayReductionBuf_1 provides a reduction buffer for
 * class {@linkplain Signed8BitIntegerArrayBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class Signed8BitIntegerArrayReductionBuf_1
	extends Signed8BitIntegerArrayBuf_1
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new signed 8-bit integer array reduction buffer.
	 *
	 ...
	 */
	public Signed8BitIntegerArrayReductionBuf_1
		(int[] theArray,
		 Range theRange,
		 IntegerOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("Signed8BitIntegerArrayReductionBuf_1(): op is null");
			}
		myOp = op;
		}
...
// Exported operations.
	...
	public void copy
		...
		else if (theSrc instanceof Signed8BitIntegerArrayBuf)
			{
			Signed8BitIntegerArrayBuf src = (Signed8BitIntegerArrayBuf) theSrc;
			ReduceArrays.reduce
