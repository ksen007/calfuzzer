//******************************************************************************
//
// File:    FloatItemBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.FloatItemBuf
//
...
/**
 * Class FloatItemBuf provides a buffer for a single float item sent or
 * received using the Message Protocol (MP). While an instance of class
 * FloatItemBuf may be constructed directly, normally you will use a factory
 * method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.FloatBuf FloatBuf}. See that
 * class for further information.
 *
 * @author  Alan Kaminsky
 * @version 25-Oct-2007
 */
public class FloatItemBuf
	extends FloatBuf
	{
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new FloatItemReductionBuf (this, (FloatOp) op);
		}
