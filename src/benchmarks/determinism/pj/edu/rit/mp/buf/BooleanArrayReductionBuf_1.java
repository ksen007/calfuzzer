//******************************************************************************
//
// File:    BooleanArrayReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.BooleanArrayReductionBuf_1
//
...
/**
 * Class BooleanArrayReductionBuf_1 provides a reduction buffer for class
 * {@linkplain BooleanArrayBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 25-Oct-2007
 */
class BooleanArrayReductionBuf_1
	extends BooleanArrayBuf_1
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new Boolean array reduction buffer.
	 *
	 ...
	 */
	public BooleanArrayReductionBuf_1
		(boolean[] theArray,
		 Range theRange,
		 BooleanOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("BooleanArrayReductionBuf_1(): op is null");
			}
		myOp = op;
		}
...
// Exported operations.
	...
	public void put
		(int i,
		 boolean item)
		{
		int j = myArrayOffset + i;
		myArray[j] = myOp.op (myArray[j], item);
		}
	...
	public void copy
		...
		else if (theSrc instanceof BooleanArrayBuf)
			{
...
// Hidden operations.
	...
	protected int receiveItems
		...
		while (index < max && buffer.remaining() >= 1)
			{
			myArray[off] = myOp.op (myArray[off], buffer.get() != 0);
			++ index;
			++ off;
			}
		return index - i;
