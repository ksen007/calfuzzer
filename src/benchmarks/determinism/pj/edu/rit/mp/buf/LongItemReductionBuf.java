//******************************************************************************
//
// File:    LongItemReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.LongItemReductionBuf
//
...
// Exported constructors.
	...
	/**
	 * Construct a new long item reduction buffer.
	 *
	...
	public LongItemReductionBuf
		...
		if (op == null)
			...
			throw new NullPointerException
				("LongItemReductionBuf(): op is null");
			}
		myBuf = buf;
		myOp = op;
		}
...
// Hidden operations.
	...
	protected int receiveItems
		...
		if (num >= 1 && buffer.remaining() >= 8)
			{
			myBuf.item = myOp.op (myBuf.item, buffer.getLong());
			return 1;
			}
		else
			{
