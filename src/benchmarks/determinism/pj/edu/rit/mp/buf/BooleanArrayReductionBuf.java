//******************************************************************************
//
// File:    BooleanArrayReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.BooleanArrayReductionBuf
//
...
/**
 * Class BooleanArrayReductionBuf provides a reduction buffer for class
 * {@linkplain BooleanArrayBuf}.
 *
 * @author  Alan Kaminsky
 * @version 25-Oct-2007
 */
class BooleanArrayReductionBuf
...
// Exported constructors.
	 ...
	 */
	public BooleanArrayReductionBuf
		(boolean[] theArray,
		 Range theRange,
		 BooleanOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("BooleanArrayReductionBuf(): op is null");
			}
		myOp = op;
		}
