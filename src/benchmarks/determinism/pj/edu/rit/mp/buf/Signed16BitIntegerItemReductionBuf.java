//******************************************************************************
//
// File:    Signed16BitIntegerItemReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Signed16BitIntegerItemReductionBuf
//
...
import benchmarks.determinism.pj.edu.ritmp.Signed16BitIntegerBuf;
...
/**
 * Class Signed16BitIntegerItemReductionBuf provides a reduction buffer for
 * class {@linkplain Signed16BitIntegerItemBuf}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class Signed16BitIntegerItemReductionBuf
	extends Signed16BitIntegerBuf
	{

// Hidden data members.

	Signed16BitIntegerItemBuf myBuf;
	IntegerOp myOp;

// Exported constructors.

	/**
	 * Construct a new signed 16-bit integer item reduction buffer.
	 *
	 ...
	 */
	public Signed16BitIntegerItemReductionBuf
		(Signed16BitIntegerItemBuf buf,
		 IntegerOp op)
		{
		super (1);
		if (op == null)
			...
			throw new NullPointerException
				("Signed16BitIntegerItemReductionBuf(): op is null");
			}
		myBuf = buf;
		myOp = op;
		}
