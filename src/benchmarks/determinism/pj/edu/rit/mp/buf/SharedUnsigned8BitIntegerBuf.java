//******************************************************************************
//
// File:    SharedUnsigned8BitIntegerBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedUnsigned8BitIntegerBuf
//
 ...
 * instance of class SharedUnsigned8BitIntegerBuf may be constructed directly,
 ...
 * @version 26-Oct-2007
 */
public class SharedUnsigned8BitIntegerBuf
...
// Exported constructors.
	 ...
	 */
	public SharedUnsigned8BitIntegerBuf
		(SharedInteger item)
		{
		super (1);
		myItem = item;
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new SharedUnsigned8BitIntegerReductionBuf
			(myItem, (IntegerOp) op);
		}
