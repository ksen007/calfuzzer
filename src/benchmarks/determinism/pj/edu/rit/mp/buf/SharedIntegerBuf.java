//******************************************************************************
//
// File:    SharedIntegerBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedIntegerBuf
//
 ...
 * SharedIntegerBuf may be constructed directly, normally you will use a factory
 * method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.IntegerBuf IntegerBuf}. See that
 * class for further information.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
public class SharedIntegerBuf
	extends IntegerBuf
	{
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new SharedIntegerReductionBuf (myItem, (IntegerOp) op);
		}
