...
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Signed16BitIntegerMatrixReductionBuf
//
...
// Exported constructors.
	 ...
	 */
	public Signed16BitIntegerMatrixReductionBuf
		(int[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 IntegerOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("Signed16BitIntegerMatrixReductionBuf(): op is null");
			}
		myOp = op;
		}
