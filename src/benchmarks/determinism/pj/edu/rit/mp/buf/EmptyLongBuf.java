//******************************************************************************
//
// File:    EmptyLongBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.EmptyLongBuf
//
...
/**
 * Class EmptyLongBuf provides a long buffer that contains no items for
 * messages using the Message Protocol (MP). When a message is sent from an
 * EmptyLongBuf, the message item type is <TT>long</TT> and the message
 * length is 0. When a message is received into an EmptyLongBuf, the message
 * item type must be <TT>long</TT>, but all items in the message are
 * discarded.
 *
 * @author  Alan Kaminsky
 * @version 19-Nov-2007
 */
public class EmptyLongBuf
	extends LongBuf
	{
