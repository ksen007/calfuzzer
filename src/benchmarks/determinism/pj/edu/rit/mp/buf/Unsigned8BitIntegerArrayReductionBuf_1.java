//******************************************************************************
//
// File:    Unsigned8BitIntegerArrayReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Unsigned8BitIntegerArrayReductionBuf_1
//
...
/**
 * Class Unsigned8BitIntegerArrayReductionBuf_1 provides a reduction buffer for
 * class {@linkplain Unsigned8BitIntegerArrayBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class Unsigned8BitIntegerArrayReductionBuf_1
	extends Unsigned8BitIntegerArrayBuf_1
	{
...
// Exported constructors.
	 ...
	 */
	public Unsigned8BitIntegerArrayReductionBuf_1
		(int[] theArray,
		 Range theRange,
		 IntegerOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("Unsigned8BitIntegerArrayReductionBuf_1(): op is null");
			}
		myOp = op;
		}
