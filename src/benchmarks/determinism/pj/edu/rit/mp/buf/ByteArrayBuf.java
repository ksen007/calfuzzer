...
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.ByteArrayBuf
//
...
/**
 * Class ByteArrayBuf provides a buffer for an array of byte items sent
 * or received using the Message Protocol (MP). The array element stride may be
 * 1 or greater than 1. While an instance of class ByteArrayBuf may be
 * constructed directly, normally you will use a factory method in class
 * {@linkplain benchmarks.determinism.pj.edu.ritmp.ByteBuf ByteBuf}. See that class for further
 * information.
 *
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new ByteArrayReductionBuf
