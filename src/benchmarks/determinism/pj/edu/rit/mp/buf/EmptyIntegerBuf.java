//******************************************************************************
//
// File:    EmptyIntegerBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.EmptyIntegerBuf
//
 ...
 * EmptyIntegerBuf, the message item type is <TT>int</TT> and the message length
 * is 0. When a message is received into an EmptyIntegerBuf, the message item
 * type must be <TT>int</TT>, but all items in the message are discarded.
 *
 * @author  Alan Kaminsky
 * @version 24-Jun-2007
 */
public class EmptyIntegerBuf
	extends IntegerBuf
	{
