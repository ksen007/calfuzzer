//******************************************************************************
//
// File:    Signed16BitIntegerArrayReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Signed16BitIntegerArrayReductionBuf
//
...
/**
 * Class Signed16BitIntegerArrayReductionBuf provides a reduction buffer for
 * class {@linkplain Signed16BitIntegerArrayBuf}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class Signed16BitIntegerArrayReductionBuf
...
// Exported constructors.
	 ...
	 */
	public Signed16BitIntegerArrayReductionBuf
		(int[] theArray,
		 Range theRange,
		 IntegerOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("Signed16BitIntegerArrayReductionBuf(): op is null");
			}
		myOp = op;
		}
