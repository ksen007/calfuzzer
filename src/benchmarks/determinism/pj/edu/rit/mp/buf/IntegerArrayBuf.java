//******************************************************************************
//
// File:    IntegerArrayBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.IntegerArrayBuf
//
...
/**
 * Class IntegerArrayBuf provides a buffer for an array of integer items
 * sent or received using the Message Protocol (MP). The array element stride
 * may be 1 or greater than 1. While an instance of class IntegerArrayBuf may
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new IntegerArrayReductionBuf
