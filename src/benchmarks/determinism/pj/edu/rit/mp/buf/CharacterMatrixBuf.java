//******************************************************************************
//
// File:    CharacterMatrixBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.CharacterMatrixBuf
//
 ...
 * CharacterMatrixBuf may be constructed directly, normally you will use a
 * factory method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.CharacterBuf CharacterBuf}.
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new CharacterMatrixReductionBuf
...
// Hidden operations.
	...
	protected int receiveItems
		...
		while (r < myRowCount && ncols > 0)
			...
			while (c < ncols)
				{
				myMatrix_row[col] = charbuffer.get();
				++ c;
				col += myColStride;
				}
			n += ncols;
