//******************************************************************************
//
// File:    ByteArrayReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.ByteArrayReductionBuf_1
//
...
/**
 * Class ByteArrayReductionBuf_1 provides a reduction buffer for class
 * {@linkplain ByteArrayBuf_1}.
 *
...
// Exported constructors.
	 ...
	 */
	public ByteArrayReductionBuf_1
		(byte[] theArray,
		 Range theRange,
		 ByteOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("ByteArrayReductionBuf_1(): op is null");
			}
		myOp = op;
		}
