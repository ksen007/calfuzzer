//******************************************************************************
//
// File:    Signed16BitIntegerMatrixReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Signed16BitIntegerMatrixReductionBuf_1
//
...
/**
 * Class Signed16BitIntegerMatrixReductionBuf_1 provides a reduction buffer for
 * class {@linkplain Signed16BitIntegerMatrixBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class Signed16BitIntegerMatrixReductionBuf_1
	extends Signed16BitIntegerMatrixBuf_1
	{
...
// Exported constructors.
	 ...
	 */
	public Signed16BitIntegerMatrixReductionBuf_1
		(int[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 IntegerOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("Signed16BitIntegerMatrixReductionBuf_1(): op is null");
			}
		myOp = op;
		}
