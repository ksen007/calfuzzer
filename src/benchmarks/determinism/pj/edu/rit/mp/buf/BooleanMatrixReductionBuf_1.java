...
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.BooleanMatrixReductionBuf_1
//
...
// Exported constructors.
	 ...
	 */
	public BooleanMatrixReductionBuf_1
		(boolean[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 BooleanOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("BooleanMatrixReductionBuf_1(): op is null");
			}
		myOp = op;
		}
