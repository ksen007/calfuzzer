//******************************************************************************
//
// File:    EmptyFloatBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.EmptyFloatBuf
//
 ...
 * EmptyFloatBuf, the message item type is <TT>float</TT> and the message
 * length is 0. When a message is received into an EmptyFloatBuf, the message
 * item type must be <TT>float</TT>, but all items in the message are
 * discarded.
 *
 * @author  Alan Kaminsky
 * @version 19-Nov-2007
 */
public class EmptyFloatBuf
	extends FloatBuf
	{
