//******************************************************************************
//
// File:    Signed16BitIntegerArrayBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Signed16BitIntegerArrayBuf
//
 ...
 * Signed16BitIntegerArrayBuf may be constructed directly, normally you will use
 * a factory method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.Signed16BitIntegerBuf
 * Signed16BitIntegerBuf}. See that class for further information.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
public class Signed16BitIntegerArrayBuf
...
// Exported constructors.
	 ...
	 */
	public Signed16BitIntegerArrayBuf
		(int[] theArray,
		 Range theRange)
		{
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new Signed16BitIntegerArrayReductionBuf
