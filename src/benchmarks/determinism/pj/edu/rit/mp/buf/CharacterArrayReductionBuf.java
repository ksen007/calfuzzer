//******************************************************************************
//
// File:    CharacterArrayReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.CharacterArrayReductionBuf
//
...
// Exported constructors.
	 ...
	 */
	public CharacterArrayReductionBuf
		(char[] theArray,
		 Range theRange,
		 CharacterOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("CharacterArrayReductionBuf(): op is null");
			}
		myOp = op;
		}
