//******************************************************************************
//
// File:    SharedDoubleArrayBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedDoubleArrayBuf
//
...
/**
 * Class SharedDoubleArrayBuf provides a buffer for a multiple thread safe
 ...
 * class SharedDoubleArrayBuf may be constructed directly, normally you will
 * use a factory method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.DoubleBuf
 * DoubleBuf}. See that class for further information.
 *
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new SharedDoubleArrayReductionBuf
