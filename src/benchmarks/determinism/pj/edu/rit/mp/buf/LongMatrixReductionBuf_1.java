//******************************************************************************
//
// File:    LongMatrixReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.LongMatrixReductionBuf_1
//
...
/**
 * Class LongMatrixReductionBuf_1 provides a reduction buffer for class
 * {@linkplain LongMatrixBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 25-Oct-2007
 */
class LongMatrixReductionBuf_1
	extends LongMatrixBuf_1
	{
...
// Exported constructors.
	 ...
	 */
	public LongMatrixReductionBuf_1
		(long[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 LongOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("LongMatrixReductionBuf_1(): op is null");
			}
		myOp = op;
		}
