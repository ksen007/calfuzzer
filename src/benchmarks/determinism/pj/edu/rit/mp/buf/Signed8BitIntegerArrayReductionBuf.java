//******************************************************************************
//
// File:    Signed8BitIntegerArrayReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Signed8BitIntegerArrayReductionBuf
//
...
/**
 * Class Signed8BitIntegerArrayReductionBuf provides a reduction buffer for
 * class {@linkplain Signed8BitIntegerArrayBuf}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class Signed8BitIntegerArrayReductionBuf
...
// Exported constructors.
	 ...
	 */
	public Signed8BitIntegerArrayReductionBuf
		(int[] theArray,
		 Range theRange,
		 IntegerOp op)
		{
		...
		if (op == null)
			...
			throw new NullPointerException
				("Signed8BitIntegerArrayReductionBuf(): op is null");
			}
		myOp = op;
		}
