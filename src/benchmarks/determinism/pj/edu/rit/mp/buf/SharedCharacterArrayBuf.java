//******************************************************************************
//
// File:    SharedCharacterArrayBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedCharacterArrayBuf
//
...
/**
 * Class SharedCharacterArrayBuf provides a buffer for a multiple thread safe
 * array of character items sent or received using the Message Protocol (MP).
 * The array element stride may be 1 or greater than 1. While an instance of
 * class SharedCharacterArrayBuf may be constructed directly, normally you will
 * use a factory method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.CharacterBuf
 * CharacterBuf}. See that class for further information.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
public class SharedCharacterArrayBuf
	extends CharacterBuf
	{

// Hidden data members.

	SharedCharacterArray myArray;
	Range myRange;
	int myArrayOffset;
	int myStride;
...
// Exported constructors.
	 ...
	 */
	public SharedCharacterArrayBuf
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new SharedCharacterArrayReductionBuf
