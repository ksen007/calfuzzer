//******************************************************************************
//
// File:    ShortMatrixReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.ShortMatrixReductionBuf
//
...
// Exported constructors.
	 ...
	 */
	public ShortMatrixReductionBuf
		(short[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 ShortOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("ShortMatrixReductionBuf(): op is null");
			}
		myOp = op;
		}
