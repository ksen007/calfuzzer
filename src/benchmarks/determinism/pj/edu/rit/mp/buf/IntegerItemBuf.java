//******************************************************************************
//
// File:    IntegerItemBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.IntegerItemBuf
//
 ...
 * IntegerItemBuf may be constructed directly, normally you will use a factory
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new IntegerItemReductionBuf (this, (IntegerOp) op);
		}
