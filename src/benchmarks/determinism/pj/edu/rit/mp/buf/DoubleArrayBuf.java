//******************************************************************************
//
// File:    DoubleArrayBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.DoubleArrayBuf
//
...
/**
 * Class DoubleArrayBuf provides a buffer for an array of double items
 * sent or received using the Message Protocol (MP). The array element stride
 * may be 1 or greater than 1. While an instance of class DoubleArrayBuf may
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new DoubleArrayReductionBuf
