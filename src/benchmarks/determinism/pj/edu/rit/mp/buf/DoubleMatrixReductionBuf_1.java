//******************************************************************************
//
// File:    DoubleMatrixReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.DoubleMatrixReductionBuf_1
//
...
/**
 * Class DoubleMatrixReductionBuf_1 provides a reduction buffer for class
 * {@linkplain DoubleMatrixBuf_1}.
 *
...
// Exported constructors.
	 ...
	 */
	public DoubleMatrixReductionBuf_1
		(double[][] theMatrix,
		 Range theRowRange,
		 Range theColRange,
		 DoubleOp op)
		...
		if (op == null)
			...
			throw new NullPointerException
				("DoubleMatrixReductionBuf_1(): op is null");
			}
		myOp = op;
		}
