//******************************************************************************
//
// File:    SharedSigned8BitIntegerBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedSigned8BitIntegerBuf
//
 ...
 * instance of class SharedSigned8BitIntegerBuf may be constructed directly,
 ...
 * @version 26-Oct-2007
 */
public class SharedSigned8BitIntegerBuf
...
// Exported constructors.
	 ...
	 */
	public SharedSigned8BitIntegerBuf
		(SharedInteger item)
		{
		super (1);
		myItem = item;
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new SharedSigned8BitIntegerReductionBuf (myItem, (IntegerOp) op);
		}
