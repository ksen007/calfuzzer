//******************************************************************************
//
// File:    EmptySigned8BitIntegerBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.EmptySigned8BitIntegerBuf
//
 ...
 * message is sent from an EmptySigned8BitIntegerBuf, the message item type is
 * signed 8-bit <TT>int</TT> and the message length is 0. When a message is
