...
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.LoopbackChannel
//
		...
		synchronized (this)
			...
			if (myWriteState == WRITE_CLOSED)
				...
				throw new IOException
					("benchmarks.determinism.pj.edu.ritmp.LoopbackChannel: Channel closed");
				}
			}
		...
		try
			...
			IOException exc2 =
				new InterruptedIOException
					("benchmarks.determinism.pj.edu.ritmp.LoopbackChannel: Send interrupted");
			exc2.initCause (exc);
			throw exc2;
			}
