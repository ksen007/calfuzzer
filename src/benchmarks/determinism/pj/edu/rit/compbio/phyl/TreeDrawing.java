...
// Unit:    Class benchmarks.determinism.pj.edu.ritcompbio.phyl.TreeDrawing
//
...
import benchmarks.determinism.pj.edu.ritdraw.item.Line;
import benchmarks.determinism.pj.edu.ritdraw.item.Point;
import benchmarks.determinism.pj.edu.ritdraw.item.Text;
...
// Main program.
	 ...
	 * {@linkplain benchmarks.determinism.pj.edu.ritdraw.Drawing} object.
	 *
	...
	/**
	 * Draw a picture of the given tree. The picture is added to the given
	 * {@linkplain benchmarks.determinism.pj.edu.ritdraw.item.Group} object.
	 *
	 * @param  tree   DNA sequence tree.
	 ...
	 * default {@linkplain benchmarks.determinism.pj.edu.ritdraw.Drawing} object.
	 *
	...
	/**
	 * Draw a picture of the given tree string. The picture is added to the
	 * given {@linkplain benchmarks.determinism.pj.edu.ritdraw.Drawing} object.
	 *
	 * @param  tree  Tree as a string in Newick Standard format.
	 * @param  dwg   Drawing object.
	 *
	...
	/**
	 * Draw a picture of the given tree string. The picture is added to the
	 * given {@linkplain benchmarks.determinism.pj.edu.ritdraw.item.Group} object.
	 *
	 * @param  tree   Tree as a string in Newick Standard format.
	 * @param  group  Drawing group object.
	 *
