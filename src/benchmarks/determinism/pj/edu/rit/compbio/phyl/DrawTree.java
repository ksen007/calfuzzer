...
// Unit:    Class benchmarks.determinism.pj.edu.ritcompbio.phyl.DrawTree
//
 ...
 * {@linkplain benchmarks.determinism.pj.edu.ritdraw.Drawing} object. The {@linkplain View} program can
 * be used to view the drawing file and save it in an image file in several
 * formats.
 * <P>
 * Usage: java benchmarks.determinism.pj.edu.ritcompbio.phyl.DrawTree "<I>tree</I>" <I>file</I> [
 * <I>format</I> ]
 ...
 * <TT>"tree.dwg"</TT>:
 * <P>
 * <TT>java benchmarks.determinism.pj.edu.ritcompbio.phyl.DrawTree \</TT>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java benchmarks.determinism.pj.edu.ritcompbio.phyl.DrawTree \"<tree>\" <file> [<format>]");
