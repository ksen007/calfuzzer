...
// Unit:    Class benchmarks.determinism.pj.edu.ritcompbio.phyl.PhylogenyParsBnbHyb
//
 ...
 * -Dpj.schedule=<I>schedule</I> ] benchmarks.determinism.pj.edu.ritcompbio.phyl.PhylogenyParsBnbHyb
...
// Main program.
	...
	public static void main
		...
		if (rank == 0)
			...
			Results.report
				(/*directory      */ outdir,
				 /*programName    */ "benchmarks.determinism.pj.edu.ritcompbio.phyl.PhylogenyParsBnbHyb",
...
//		}
	...
	private static void usage()
		{
		System.err.println ("Usage: java [-Dpj.np=<Kp>] [-Dpj.nt=<Kt>] [-Dpj.schedule=<schedule>] benchmarks.determinism.pj.edu.ritcompbio.phyl.PhylogenyParsBnbHyb <infile> <outdir> [<N> [<T>]]");
