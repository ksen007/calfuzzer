...
// Unit:    Class benchmarks.determinism.pj.edu.ritcompbio.seq.test.ListDatabase
//
 ...
 * benchmarks.determinism.pj.edu.ritcompbio.seq.ProteinSequence}. The program prints the indexes and
 * descriptions of all the protein sequences in the protein sequence database.
 * <P>
 * Usage: java benchmarks.determinism.pj.edu.ritcompbio.seq.test.ListDatabase <I>databasefile</I>
 * <I>indexfile</I>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java benchmarks.determinism.pj.edu.ritcompbio.seq.test.ListDatabase <databasefile> <indexfile>");
