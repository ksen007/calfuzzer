...
// Unit:    Class benchmarks.determinism.pj.edu.ritcompbio.seq.test.TestSeq
//
...
import benchmarks.determinism.pj.edu.ritcompbio.seq.ProteinLocalAlignmentSeq;
 ...
 * benchmarks.determinism.pj.edu.ritcompbio.seq.ProteinLocalAlignmentSeq}. The program reads in a query
 * sequence and a subject sequence, aligns them, and prints the alignment.
 * <P>
 * Usage: java benchmarks.determinism.pj.edu.ritcompbio.seq.test.TestSeq <I>queryfile</I>
 * <I>subjectfile</I>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java benchmarks.determinism.pj.edu.ritcompbio.seq.test.TestSeq <queryfile> <subjectfile>");
