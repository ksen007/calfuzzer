...
// Unit:    Class benchmarks.determinism.pj.edu.ritcompbio.seq.test.TestSmp
//
...
import benchmarks.determinism.pj.edu.ritcompbio.seq.Alignment;
import benchmarks.determinism.pj.edu.ritcompbio.seq.AlignmentPrinter;
import benchmarks.determinism.pj.edu.ritcompbio.seq.AlignmentStats;
import benchmarks.determinism.pj.edu.ritcompbio.seq.DefaultAlignmentStats;
import benchmarks.determinism.pj.edu.ritcompbio.seq.ProteinLocalAlignment;
import benchmarks.determinism.pj.edu.ritcompbio.seq.ProteinLocalAlignmentSmp;
 ...
 * benchmarks.determinism.pj.edu.ritcompbio.seq.ProteinSequence} and {@linkplain
 * benchmarks.determinism.pj.edu.ritcompbio.seq.ProteinLocalAlignmentSmp}. The program reads in a query
 * sequence and a subject sequence, aligns them in a parallel thread team, and
 * prints the alignment.
 * <P>
 * Usage: java -Dpj.nt=<I>K</I> benchmarks.determinism.pj.edu.ritcompbio.seq.test.TestSmp
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.nt=<K> benchmarks.determinism.pj.edu.ritcompbio.seq.test.TestSmp <queryfile> <subjectfile>");
