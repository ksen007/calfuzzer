...
// Unit:    Class benchmarks.determinism.pj.edu.ritcompbio.seq.FindProteinHyb
//
 ...
 * -Dpj.schedule=<I>schedule</I> ] benchmarks.determinism.pj.edu.ritcompbio.seq.FindProteinHyb
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<Kp> -Dpj.nt=<Kt> [-Dpj.schedule=<schedule>] benchmarks.determinism.pj.edu.ritcompbio.seq.FindProteinHyb <queryfile> <databasefile> <indexfile> [<expect>]");
