...
// Unit:    Class benchmarks.determinism.pj.edu.ritpj.test.Test06
//
 ...
 * ParallelRegion}, and {@linkplain benchmarks.determinism.pj.edu.ritpj.ParallelSection ParallelSection}.
 * A number of parallel sections are created and executed. Each parallel
 * section's code is slightly different.
 * <P>
 * Usage: java -Dpj.nt=<I>K</I> benchmarks.determinism.pj.edu.ritpj.test.Test06 <I>N</I>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.nt=<K> benchmarks.determinism.pj.edu.ritpj.test.Test06 <N>");
