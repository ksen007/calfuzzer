...
// Unit:    Class benchmarks.determinism.pj.edu.ritpj.test.TestSchedule
//
 ...
 * benchmarks.determinism.pj.edu.ritpj.IntegerSchedule}.
 *
...
// Exported constructors.
	...
	private static int getInitialChunkSize
		...
		if (args.length != 2)
			{
			throw new IllegalArgumentException
				("TestSchedule(): Usage: -Dpj.schedule=benchmarks.determinism.pj.edu.ritpj.test.TestSchedule or -Dpj.schedule=\"benchmarks.determinism.pj.edu.ritpj.test.TestSchedule(<n>,<incr>)\"");
			}
		int theInitialChunkSize;
		try
			{
