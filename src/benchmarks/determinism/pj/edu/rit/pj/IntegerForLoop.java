//******************************************************************************
//
// File:    IntegerForLoop.java
// Package: benchmarks.determinism.pj.edu.ritpj
// Unit:    Class benchmarks.determinism.pj.edu.ritpj.IntegerForLoop
//
 ...
 * @version 11-Nov-2007
 */
public abstract class IntegerForLoop
	...
	public final void ordered
		...
		if (theSection == null)
			...
			throw new IllegalStateException
				("IntegerForLoop.ordered(): Parallel section is null");
			}
		if (myTeam == null)
			{
			throw new IllegalStateException
				("IntegerForLoop.ordered(): No parallel team executing");
			}
