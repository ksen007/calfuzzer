//******************************************************************************
//
// File:    ReplicatedBoolean.java
// Package: benchmarks.determinism.pj.edu.ritpj.replica
// Unit:    Class benchmarks.determinism.pj.edu.ritpj.replica.ReplicatedBoolean
//
 ...
 * <OL TYPE=1>
 * <LI>
 * Construct an instance of class ReplicatedBoolean, specifying the reduction
 ...
 * </OL>
 * <P>
 * Class ReplicatedBoolean does not itself guarantee consistency of the
 ...
 * <P>
 * Class ReplicatedBoolean is multiple thread safe. The methods use lock-free
 * atomic compare-and-set.
 * <P>
 * <I>Note:</I> Class ReplicatedBoolean is implemented using class
...
// Exported constructors.
	...
	/**
	 * Construct a new replicated, shared Boolean reduction variable with the
	 * given reduction operator. The initial value is false. A message tag of 0
	...
	public ReplicatedBoolean
		...
		if (op == null)
			...
			throw new NullPointerException
				("ReplicatedBoolean(): op is null");
			}
		if (comm == null)
			{
			throw new NullPointerException
				("ReplicatedBoolean(): comm is null");
			}
		myOp = op;
...
// Exported operations.
	...
	public boolean reduce
		...
		if (newvalue != oldvalue)
			{
			myComm.floodSend (myTag, BooleanBuf.buffer (newvalue));
			}
