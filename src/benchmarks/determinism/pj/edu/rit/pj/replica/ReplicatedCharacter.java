//******************************************************************************
//
// File:    ReplicatedCharacter.java
// Package: benchmarks.determinism.pj.edu.ritpj.replica
// Unit:    Class benchmarks.determinism.pj.edu.ritpj.replica.ReplicatedCharacter
//
 ...
 * for a value of type <TT>char</TT>.
 * <P>
 ...
 * <OL TYPE=1>
 * <LI>
 * Construct an instance of class ReplicatedCharacter, specifying the reduction
 * operator (class {@linkplain benchmarks.determinism.pj.edu.ritpj.reduction.Op}) to use when performing
 * updates, and specifying the communicator (class {@linkplain benchmarks.determinism.pj.edu.ritpj.Comm})
 ...
 * </OL>
 * <P>
 * Class ReplicatedCharacter does not itself guarantee consistency of the
 ...
 * <P>
 * Class ReplicatedCharacter is multiple thread safe. The methods use lock-free
 * atomic compare-and-set.
 * <P>
 * <I>Note:</I> Class ReplicatedCharacter is implemented using class
...
// Exported constructors.
	...
	/**
	 * Construct a new replicated, shared character reduction variable with the
	...
	public ReplicatedCharacter
		...
		if (op == null)
			...
			throw new NullPointerException
				("ReplicatedCharacter(): op is null");
			}
		if (comm == null)
			{
			throw new NullPointerException
				("ReplicatedCharacter(): comm is null");
			}
		myOp = op;
...
// Exported operations.
	...
	public char reduce
		...
		if (newvalue != oldvalue)
			{
			myComm.floodSend (myTag, CharacterBuf.buffer (newvalue));
			}
