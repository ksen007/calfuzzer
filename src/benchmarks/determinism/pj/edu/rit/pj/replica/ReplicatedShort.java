//******************************************************************************
//
// File:    ReplicatedShort.java
// Package: benchmarks.determinism.pj.edu.ritpj.replica
// Unit:    Class benchmarks.determinism.pj.edu.ritpj.replica.ReplicatedShort
//
 ...
 * <OL TYPE=1>
 * <LI>
 * Construct an instance of class ReplicatedShort, specifying the reduction
 ...
 * </OL>
 * <P>
 * Class ReplicatedShort does not itself guarantee consistency of the
 ...
 * <P>
 * Class ReplicatedShort is multiple thread safe. The methods use lock-free
 * atomic compare-and-set.
 * <P>
 * <I>Note:</I> Class ReplicatedShort is implemented using class
...
// Exported constructors.
	...
	/**
	 * Construct a new replicated, shared short reduction variable with the
	...
	public ReplicatedShort
		...
		if (op == null)
			...
			throw new NullPointerException
				("ReplicatedShort(): op is null");
			}
		if (comm == null)
			{
			throw new NullPointerException
				("ReplicatedShort(): comm is null");
			}
		myOp = op;
...
// Exported operations.
	...
	public short reduce
		...
		if (newvalue != oldvalue)
			{
			myComm.floodSend (myTag, ShortBuf.buffer (newvalue));
			}
