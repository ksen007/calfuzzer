...
// Unit:    Class benchmarks.determinism.pj.edu.ritpj.LongSchedule
//
...
// Hidden operations.
	...
	private static String getSubclassName
		...
		if (name.equals ("fixed"))
			{
			return "benchmarks.determinism.pj.edu.ritpj.FixedLongSchedule";
			}
		else if (name.equals ("dynamic"))
			{
			return "benchmarks.determinism.pj.edu.ritpj.DynamicLongSchedule";
			}
		else if (name.equals ("guided"))
			{
			return "benchmarks.determinism.pj.edu.ritpj.GuidedLongSchedule";
			}
		else
			{
			return name;
...
//		if (args.length != 4)
//			{
//			System.err.println ("Usage: java [-Dpj.schedule=<SCHEDULE>] benchmarks.determinism.pj.edu.ritpj.LongSchedule <K> <lb> <ub> <stride>");
//			System.exit (1);
//			}
