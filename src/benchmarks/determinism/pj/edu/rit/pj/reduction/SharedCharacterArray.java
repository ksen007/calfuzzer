//******************************************************************************
//
// File:    SharedCharacterArray.java
// Package: benchmarks.determinism.pj.edu.ritpj.reduction
// Unit:    Class benchmarks.determinism.pj.edu.ritpj.reduction.SharedCharacterArray
//
...
/**
 * Class SharedCharacterArray provides an array reduction variable with elements
 * of type <TT>char</TT>.
 * <P>
 * Class SharedCharacterArray is multiple thread safe. The methods use lock-free
 * atomic compare-and-set.
 * <P>
 * <I>Note:</I> Class SharedCharacterArray is implemented using class
 * java.util.concurrent.atomic.AtomicIntegerArray. Each character array element
 * is stored as an <TT>int</TT> whose values are restricted to the range of type
 * <TT>char</TT>.
 *
...
// Exported constructors.
	...
	/**
	 * Construct a new character array reduction variable whose elements are
...
// Exported operations.
	...
	public char getAndSet
		(int i,
		 char value)
		{
		return (char) myArray.getAndSet (i, value);
		}
	...
	public char getAndIncrement
		...
		for (;;)
			{
			char oldvalue = (char) myArray.get (i);
	...
	public void reduce
		...
		while (len > 0)
			...
			updateLoop: for (;;)
				{
				char oldvalue = (char) myArray.get (dstoff);
				char newvalue = op.op (oldvalue, src[srcoff]);
