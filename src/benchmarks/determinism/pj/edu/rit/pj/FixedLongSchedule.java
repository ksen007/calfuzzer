//******************************************************************************
//
// File:    FixedLongSchedule.java
// Package: benchmarks.determinism.pj.edu.ritpj
// Unit:    Class benchmarks.determinism.pj.edu.ritpj.FixedLongSchedule
//
...
/**
 * Class FixedLongSchedule provides a fixed schedule object. The loop index
 * is type <TT>long</TT>. The loop iterations are apportioned among the parallel
...
// Exported constructors.
	...
	public FixedLongSchedule
		...
		throw new IllegalArgumentException
			("FixedLongSchedule(): Usage: -Dpj.schedule=fixed");
		}
