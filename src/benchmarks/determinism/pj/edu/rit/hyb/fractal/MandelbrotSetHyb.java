...
// Unit:    Class benchmarks.determinism.pj.edu.rithyb.fractal.MandelbrotSetHyb
//
 ...
 * -Dpj.schedule=<I>schedule</I> ] benchmarks.determinism.pj.edu.rithyb.fractal.MandelbrotSetHyb
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<Kp> -Dpj.nt=<Kt> [-Dpj.schedule=<schedule>] benchmarks.determinism.pj.edu.rithyb.fractal.MandelbrotSetHyb <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <gamma> <filename>");
