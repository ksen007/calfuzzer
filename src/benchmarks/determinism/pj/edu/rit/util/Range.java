...
// Unit:    Class benchmarks.determinism.pj.edu.ritutil.Range
//
...
// Exported operations.
	...
	public Range subrange
		...
		if (size < 1)
			{
			throw new IllegalArgumentException
				("Range.subrange(): size = " + size + " illegal");
			}
		if (0 > rank || rank >= size)
			{
			throw new IllegalArgumentException
				("Range.subrange(): rank = " + rank + " illegal");
			}
	...
	public Range[] subranges
		...
		if (size < 1)
			{
			throw new IllegalArgumentException
				("Range.subranges(): size = " + size + " illegal");
			}
	...
	public Range chunk
		...
		if (N1 < 0)
			{
			throw new IllegalArgumentException
				("Range.chunk(): N1 = " + N1 + " illegal");
			}
		if (N2 < 0)
			{
			throw new IllegalArgumentException
				("Range.chunk(): N2 = " + N2 + " illegal");
			}
...
//		if (args.length != 4)
//			{
//			System.err.println ("Usage: benchmarks.determinism.pj.edu.ritutil.Range <lb> <ub> <stride> <size>");
//			System.exit (1);
//			}
