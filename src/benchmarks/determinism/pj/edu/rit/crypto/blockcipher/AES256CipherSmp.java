//******************************************************************************
//
// File:    AES256CipherSmp.java
// Package: benchmarks.determinism.pj.edu.ritcrypto.blockcipher
// Unit:    Class benchmarks.determinism.pj.edu.ritcrypto.blockcipher.AES256CipherSmp
//
...
/**
 * Class AES256CipherSmp provides a {@linkplain BlockCipher} using the Advanced
 ...
 * <P>
 * Unlike class {@linkplain AES256Cipher}, class AES256CipherSmp includes extra
 * padding in the memory layout to avoid cache interference when running a
 * program with multiple threads on an SMP parallel computer.
 *
...
// Hidden helper classes.
	...
	private static class RoundKey
		...
		// 128 bytes of padding, to avert cache interference when running on an
		// SMP parallel computer.
...
// Exported operations.
	...
	public void setKey
		...
		if (expandedKey == null)
			{
			expandedKey = new RoundKey [ROUND_KEY_COUNT+32]; // extra padding
...
//			if (args.length != 2)
//				{
//				System.err.println ("Usage: java benchmarks.determinism.pj.edu.ritcrypto.blockcipher.AES256CipherSmp <key> <block>");
//				System.exit (1);
//				}
...
//			AES256CipherSmp bc = new AES256CipherSmp (key);
//
//			// Dump key schedule.
...
//		catch (Throwable exc)
//			{
//			System.err.println ("AES256CipherSmp: Uncaught exception");
