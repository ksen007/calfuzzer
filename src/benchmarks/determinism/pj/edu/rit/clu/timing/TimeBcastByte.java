//******************************************************************************
//
// File:    TimeBcastByte.java
// Package: benchmarks.determinism.pj.edu.ritclu.timing
// Unit:    Class benchmarks.determinism.pj.edu.ritclu.timing.TimeBcastByte
//
...
/**
 * Class TimeBcastByte measures the time to broadcast a message on a workstation
 * cluster computer using Parallel Java (PJ). The program runs on <I>K</I> &gt;=
 * 2 processors. The program creates an <I>n</I>-byte message, broadcasts the
 ...
 * message size <I>n</I>.
 * <P>
 * Usage: java -Dpj.np=<I>K</I> benchmarks.determinism.pj.edu.ritclu.timing.TimeBcastByte <I>reps</I>
 * <I>n1</I> [ <I>n2</I> . . . ]
...
// Main program.
	...
	public static void main
		...
		if (rank == 0)
			...
			System.out.println
				("java -Dpj.np=" + size +
				 " benchmarks.determinism.pj.edu.ritclu.timing.TimeBcastByte " + reps);
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<K> benchmarks.determinism.pj.edu.ritclu.timing.TimeBcastByte <reps> <n1> [<n2> ...]");
