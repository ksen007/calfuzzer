//******************************************************************************
//
// File:    TimeBcastInt.java
// Package: benchmarks.determinism.pj.edu.ritclu.timing
// Unit:    Class benchmarks.determinism.pj.edu.ritclu.timing.TimeBcastInt
//
...
/**
 * Class TimeBcastInt measures the time to broadcast a message on a workstation
 * cluster computer using Parallel Java (PJ). The program runs on <I>K</I> &gt;=
 * 2 processors. The program creates an <I>n</I>-integer message, broadcasts the
 * message repeatedly for a certain number of repetitions, and measures the time
 * to broadcast one message. The program repeats this for certain values of the
 * message size <I>n</I>.
 * <P>
 * Usage: java -Dpj.np=<I>K</I> benchmarks.determinism.pj.edu.ritclu.timing.TimeBcastInt <I>reps</I>
 * <I>n1</I> [ <I>n2</I> . . . ]
 ...
 * @version 13-Dec-2007
 */
public class TimeBcastInt
	{

// Prevent construction.

	private TimeBcastInt()
		{
		}
...
// Main program.
	...
	public static void main
		...
		if (rank == 0)
			...
			System.out.println
				("java -Dpj.np=" + size +
				 " benchmarks.determinism.pj.edu.ritclu.timing.TimeBcastInt " + reps);
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<K> benchmarks.determinism.pj.edu.ritclu.timing.TimeBcastInt <reps> <n1> [<n2> ...]");
