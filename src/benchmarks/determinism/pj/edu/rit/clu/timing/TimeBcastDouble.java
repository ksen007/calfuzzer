...
// Unit:    Class benchmarks.determinism.pj.edu.ritclu.timing.TimeBcastDouble
//
 ...
 * <P>
 * Usage: java -Dpj.np=<I>K</I> benchmarks.determinism.pj.edu.ritclu.timing.TimeBcastDouble <I>reps</I>
 * <I>n1</I> [ <I>n2</I> . . . ]
...
// Main program.
	...
	public static void main
		...
		if (rank == 0)
			...
			System.out.println
				("java -Dpj.np=" + size +
				 " benchmarks.determinism.pj.edu.ritclu.timing.TimeBcastDouble " + reps);
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<K> benchmarks.determinism.pj.edu.ritclu.timing.TimeBcastDouble <reps> <n1> [<n2> ...]");
