...
// Unit:    Class benchmarks.determinism.pj.edu.ritclu.timing.TimeSendInt
//
 ...
 * message size <I>n</I>.
 * <P>
 * Usage: java -Dpj.np=2 benchmarks.determinism.pj.edu.ritclu.timing.TimeSendInt <I>reps</I> <I>n1</I>
 * [ <I>n2</I> . . . ]
...
// Main program.
	...
	public static void main
		...
		if (rank == 0)
			{
			System.out.println
				("java -Dpj.np=2 benchmarks.determinism.pj.edu.ritclu.timing.TimeSendInt " + reps);
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=2 benchmarks.determinism.pj.edu.ritclu.timing.TimeSendInt <reps> <n1> [<n2> ...]");
