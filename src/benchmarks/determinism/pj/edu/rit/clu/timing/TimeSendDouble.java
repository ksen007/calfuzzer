//******************************************************************************
//
// File:    TimeSendDouble.java
// Package: benchmarks.determinism.pj.edu.ritclu.timing
// Unit:    Class benchmarks.determinism.pj.edu.ritclu.timing.TimeSendDouble
//
...
/**
 * Class TimeSendDouble measures the time to send a message on a workstation
 * cluster computer using Parallel Java (PJ). The program runs on two
 * processors. The program creates an <I>n</I>-double message, sends the
 ...
 * message size <I>n</I>.
 * <P>
 * Usage: java -Dpj.np=2 benchmarks.determinism.pj.edu.ritclu.timing.TimeSendDouble <I>reps</I> <I>n1</I>
 * [ <I>n2</I> . . . ]
...
// Main program.
	...
	public static void main
		...
		if (rank == 0)
			{
			System.out.println
				("java -Dpj.np=2 benchmarks.determinism.pj.edu.ritclu.timing.TimeSendDouble " + reps);
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=2 benchmarks.determinism.pj.edu.ritclu.timing.TimeSendDouble <reps> <n1> [<n2> ...]");
