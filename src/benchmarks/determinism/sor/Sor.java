...
package benchmarks.determinism.sor;
...
public class Sor {
	...
	if (!nop) {
            ...
            requireDeterministic(red_, new ApproxEquals(1e-12));
            requireDeterministic(black_, new ApproxEquals(1e-12));
		...
		try {
            ...
            assertDeterministic(red_, new ApproxEquals(1e-7));
            assertDeterministic(black_, new ApproxEquals(1e-7));
